import { isAnonymousUser, saveToDB, updateQuestionAnswerUsers } from "./utils";
...
export function initialiseLearnedGoals(initLearnedNodes, initGoalNodes) {
  if (typeof initLearnedNodes === "string") {
    learnedNodes = JSON.parse(initLearnedNodes);
  } else {
    learnedNodes = initLearnedNodes;
  }
  if (typeof initGoalNodes === "string") {
    goalNodes = JSON.parse(initGoalNodes);
  } else {
    goalNodes = initGoalNodes;
  }
}

export function resetProgress(backendUrl, userId, mapUUID, sessionId) {
...
export function onLearnedSliderClick(
  node,
  backendUrl,
  userId,
  mapUUID,
...
export function onSetGoalSliderClick(
  node,
  backendUrl,
  userId,
  mapUUID,
