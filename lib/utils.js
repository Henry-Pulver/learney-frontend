...
export const allowSuggestions = true;
let alreadyQuestionAnswerUser = true;
...
export function getButtonPressFunction(backendUrl, userId, sessionId) {
  return function (runFirst, buttonName) {
    return buttonPress(runFirst, buttonName, backendUrl, userId, sessionId);
  };
}
...
export function updateQuestionAnswerUsers(userId) {
